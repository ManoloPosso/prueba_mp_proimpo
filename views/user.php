...
<div class="col-xs-12">
    ...
    <br>
		<div>
			<a class="btn reg_usuario" href="../index.php">Nuevo usuario 
      <i class="fa fa-plus"></i>
       </a>
       <a class="btn area_supervisores" href="../views/empleados.php">Empleados
      <i class="fa fa-plus"></i>
       </a>
...
<td>
<a class="btn reg_usuario" href="editar_user.php?id=<?php echo $fila['id']?> ">
